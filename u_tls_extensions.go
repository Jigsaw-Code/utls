...
type TLSExtension interface {
	writeToExtendedConfig(*ExtendedConfig) error
...
func (e *NPNExtension) writeToExtendedConfig(ec *ExtendedConfig) error {
	ec.config.NextProtos = e.NextProtos
	ec.Hello.NextProtoNeg = true
	return nil
}
...
func (e *SNIExtension) writeToExtendedConfig(ec *ExtendedConfig) error {
	ec.config.ServerName = e.ServerName
	ec.Hello.ServerName = e.ServerName
	return nil
}
...
func (e *StatusRequestExtension) writeToExtendedConfig(ec *ExtendedConfig) error {
	ec.Hello.OcspStapling = true
	return nil
}
...
func (e *SupportedCurvesExtension) writeToExtendedConfig(ec *ExtendedConfig) error {
	ec.config.CurvePreferences = e.Curves
	ec.Hello.SupportedCurves = e.Curves
	return nil
}
...
func (e *SupportedPointsExtension) writeToExtendedConfig(ec *ExtendedConfig) error {
	ec.Hello.SupportedPoints = e.SupportedPoints
	return nil
}
...
func (e *SignatureAlgorithmsExtension) writeToExtendedConfig(ec *ExtendedConfig) error {
	ec.Hello.SignatureAndHashes = e.SignatureAndHashes
	return nil
}
...
func (e *RenegotiationInfoExtension) writeToExtendedConfig(ec *ExtendedConfig) error {
	ec.config.Renegotiation = e.renegotiation
	switch e.renegotiation {
	case RenegotiateOnceAsClient:
		fallthrough
	case RenegotiateFreelyAsClient:
		ec.Hello.SecureRenegotiationSupported = true
		// Note that if we manage to use this in renegotiation(currently only in initial handshake), we'd have to point
		// ec.hello.SecureRenegotiation = chs.C.clientFinished
...
func (e *ALPNExtension) writeToExtendedConfig(ec *ExtendedConfig) error {
	ec.config.NextProtos = e.AlpnProtocols
	ec.Hello.AlpnProtocols = e.AlpnProtocols
	return nil
}
...
func (e *SCTExtension) writeToExtendedConfig(ec *ExtendedConfig) error {
	ec.Hello.Scts = true
	return nil
}
...
func (e *SessionTicketExtension) writeToExtendedConfig(ec *ExtendedConfig) error {
	if e.Session != nil {
		ec.Session = e.Session
	}
	return nil
}
...
func (e *FakeChannelIDExtension) writeToExtendedConfig(ec *ExtendedConfig) error {
	return nil
}
...
// but we'll probably won't have to enable it in Config
func (e *FakeExtendedMasterSecretExtension) writeToExtendedConfig(ec *ExtendedConfig) error {
	return nil
}
...
func (e *FakeGREASEExtension) writeToExtendedConfig(ec *ExtendedConfig) error {
	return nil
}
...
type FakePaddingExtension struct {
	...
	GetPadingLen func(clientHelloUnpaddedLen int) (paddingLen int, willPad bool)
}

func (e *FakePaddingExtension) writeToExtendedConfig(ec *ExtendedConfig) error {
	return nil
}
...
func (e *FakePaddingExtension) Update(clientHelloUnpaddedLen int) {
	if e.GetPadingLen == nil {
		e.WillPad = false
		e.PaddingLen = 0
	} else {
		e.PaddingLen, e.WillPad = e.GetPadingLen(clientHelloUnpaddedLen)
	}
}
